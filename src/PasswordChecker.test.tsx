...
describe("PasswordChecker Test Suite", () => {
  ...
  it("sets rtl className when `rtl` prop is set", () => {
    const result = mount(
      <PasswordChecker rules={["minLength"]} minLength={6} value="123456" rtl />
    );
  ...
  it("gracefully handles if text colors are not defined", () => {
    const result = mount(
      <PasswordChecker rules={["minLength"]} minLength={8} value="123456" />
    );
  ...
  describe("iconComponents", () => {
    it("has the default icons", () => {
      const result = mount(
        <PasswordChecker rules={["minLength"]} minLength={6} value="123456" />
      );
  ...
  describe("minLength", () => {
    it("Displays the default minLength message", () => {
      const result = mount(
        <PasswordChecker rules={["minLength"]} minLength={6} value="" />
      );
    ...
    it("Sets invalid", () => {
      const result = mount(
        <PasswordChecker rules={["minLength"]} minLength={6} value="12345" />
      );
  ...
  describe("maxLength", () => {
    it("Displays the default maxLength message", () => {
      const result = mount(
        <PasswordChecker rules={["maxLength"]} maxLength={16} value="" />
      );
      expect(result.find("span").text()).toEqual(
        "Password has no more than 16 characters."
      );
    });
    it("Sets invalid", () => {
      const result = mount(
  ...
  describe("specialChar", () => {
    it("Displays the default specialChar message", () => {
      const result = mount(
        <PasswordChecker rules={["specialChar"]} value="" />
      );
      expect(result.find("span").text()).toEqual(
    ...
    it("Sets valid with _", () => {
      const result = mount(
        <PasswordChecker rules={["specialChar"]} value="_" />
      );
      expect(result.find("li").hasClass("valid")).toBeTruthy();
    });
    it("Sets valid with ¿", () => {
  ...
  describe("capital", () => {
    it("Displays the default capital message", () => {
      const result = mount(<PasswordChecker rules={["capital"]} value="" />);
      expect(result.find("span").text()).toEqual(
    ...
    it("Sets invalid", () => {
      const result = mount(
        <PasswordChecker rules={["capital"]} value="as;lkj23408" />
      );
      expect(result.find("li").hasClass("invalid")).toBeTruthy();
    });
    it("Sets valid", () => {
      const result = mount(
        <PasswordChecker rules={["capital"]} value="s;lKj23408" />
      );
      expect(result.find("li").hasClass("valid")).toBeTruthy();
    });
  });
  describe("lowercase", () => {
    it("Displays the default lowercase message", () => {
      const result = mount(<PasswordChecker rules={["lowercase"]} value="" />);
      expect(result.find("span").text()).toEqual(
    ...
    it("Sets invalid", () => {
      const result = mount(
        <PasswordChecker rules={["lowercase"]} value="I'M ALL CAPITALS 1234" />
      );
      expect(result.find("li").hasClass("invalid")).toBeTruthy();
    });
    it("Sets valid", () => {
      const result = mount(
        <PasswordChecker
          rules={["lowercase"]}
          value="I HAVE a LOWERCASE LETTER 1234"
        />
      );
      expect(result.find("li").hasClass("valid")).toBeTruthy();
    });
  ...
  describe("noSpaces", () => {
    it("Displays the default no space message", () => {
      const result = mount(<PasswordChecker rules={["noSpaces"]} value="" />);
      expect(result.find("span").text()).toEqual(
    ...
    it("Sets valid", () => {
      const result = mount(
        <PasswordChecker rules={["noSpaces"]} value="Idonthavespaces" />
      );
      expect(result.find("li").hasClass("valid")).toBeTruthy();
    });
    ...
    it("Sets invalid for space (' ') ", () => {
      const result = mount(
        <PasswordChecker rules={["noSpaces"]} value="I have spaces" />
      );
      expect(result.find("li").hasClass("invalid")).toBeTruthy();
    });
    it("Sets invalid for tab space character (\t)", () => {
      const result = mount(
        <PasswordChecker rules={["noSpaces"]} value={`ihave\tatabspace`} />
      );
      expect(result.find("li").hasClass("invalid")).toBeTruthy();
    });
    it("Sets invalid for new line character (\n)", () => {
      const result = mount(
        <PasswordChecker rules={["noSpaces"]} value={`Ihave\nanewline`} />
      );
      expect(result.find("li").hasClass("invalid")).toBeTruthy();
    });
    ...
    it("Sets invalid for form feed character (\f)", () => {
      const result = mount(
        <PasswordChecker rules={["noSpaces"]} value={`Ihavea\fformfeed`} />
      );
      expect(result.find("li").hasClass("invalid")).toBeTruthy();
    });
  });
  describe("capitalAndLowercase", () => {
    it("Displays the default capitalAndLowercase message", () => {
      const result = mount(
        <PasswordChecker rules={["capitalAndLowercase"]} value="" />
      );
      expect(result.find("span").text()).toEqual(
  ...
  describe("letter", () => {
    it("Displays the default letter message", () => {
      const result = mount(<PasswordChecker rules={["letter"]} value="" />);
      expect(result.find("span").text()).toEqual("Password has a letter.");
    });
    it("Sets invalid", () => {
      const result = mount(<PasswordChecker rules={["letter"]} value="1234" />);
      expect(result.find("li").hasClass("invalid")).toBeTruthy();
    });
    it("Sets valid with lowercase", () => {
      const result = mount(
        <PasswordChecker rules={["letter"]} value="i have a letter" />
      );
      expect(result.find("li").hasClass("valid")).toBeTruthy();
    });
  ...
  describe("notEmpty", () => {
    it("Displays the default notEmpty message", () => {
      const result = mount(<PasswordChecker rules={["notEmpty"]} value="" />);
      expect(result.find("span").text()).toEqual(
    ...
    it("Sets invalid", () => {
      ...
      const againResult = mount(
        <PasswordChecker rules={["notEmpty"]} value="1" valueAgain="" />
      );
      expect(againResult.find("li").hasClass("invalid")).toBeTruthy();
    });
    it("Sets valid", () => {
      const result = mount(
        <PasswordChecker rules={["notEmpty"]} value="0" valueAgain="1" />
      );
      expect(result.find("li").hasClass("valid")).toBeTruthy();
    });
  });
  describe("match", () => {
    it("Displays the default match message", () => {
      const result = mount(
        <PasswordChecker rules={["match"]} value="test" valueAgain="test" />
      );
      expect(result.find("span").text()).toEqual("Passwords match.");
    });
    it("Sets invalid when empty", () => {
      const result = mount(
        <PasswordChecker rules={["match"]} value="" valueAgain="" />
      );
      expect(result.find("li").hasClass("invalid")).toBeTruthy();
    });
    it("Sets invalid when non-matching", () => {
      const result = mount(
        <PasswordChecker rules={["match"]} value="1" valueAgain="2" />
      );
      expect(result.find("li").hasClass("invalid")).toBeTruthy();
    });
    it("Sets valid", () => {
