...
import PasswordChecker, { RuleNames } from "../index";
...
export const Default: Story = (args) => (
  <PasswordChecker {...args} onChange={action("onChange")} />
);
...
export const CustomIconAndColors: Story = (args) => (
  <PasswordChecker
    validTextColor="ForestGreen"
    invalidTextColor="fuchsia"
    validColor="#c7ad00"
    invalidColor="#380091"
    {...args}
    onChange={action("onChange")}
...
export const CustomMessages: Story = (args) => (
  <PasswordChecker
    ...
    messages={{
      ...
      specialChar: "La contraseña contiene caracteres especiales.",
      number: "La contraseña incluye un número.",
